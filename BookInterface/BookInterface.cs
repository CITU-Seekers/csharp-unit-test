...
namespace CodeChum
{
    public partial class BookInterface : Form
    {
        ...
        {
            if (cboBooks.SelectedItem.ToString() == "Harry Potter")
            {
                BookList.Items.Clear();
                BookList.Items.Add("Harry Potter and the Sorcerer's Stone");
                BookList.Items.Add("Harry Potter and the Chamber of Secrets");
                BookList.Items.Add("Harry Potter and the Prisoner of Azkaban");
                BookList.Items.Add("Harry Potter and the Goblet of Fire");
                BookList.Items.Add("Harry Potter and the Order of the Phoenix");
                BookList.Items.Add("Harry Potter and the Half-Blood Prince");
                BookList.Items.Add("Harry Potter and the Deathly Hallows");
            }
            else if (cboBooks.SelectedItem.ToString() == "Magnus Chase")
            {
                BookList.Items.Clear();
                BookList.Items.Add("The Sword of Summer");
                BookList.Items.Add("The Hammer of Thor");
                BookList.Items.Add("The Ship of the Dead");
            }
            else if (cboBooks.SelectedItem.ToString() == "Percy Jackson")
            {
                BookList.Items.Clear();
                BookList.Items.Add("The Lightning Thief");
                BookList.Items.Add("The Sea of Monsters");
                BookList.Items.Add("The Titan's Curse");
                BookList.Items.Add("The Battle of the Labyrinth");
                BookList.Items.Add("The Last Olympian");
            }
            else if (cboBooks.SelectedItem.ToString() == "The Maze Runner")
            {
                BookList.Items.Clear();
                BookList.Items.Add("The Maze Runner");
                BookList.Items.Add("The Scorch Trials");
                BookList.Items.Add("The Death Cure");
                BookList.Items.Add("The Kill Order");
                BookList.Items.Add("The Fever Code");
            }
            else if (cboBooks.SelectedItem.ToString() == "The Hunger Games")
            {
                BookList.Items.Clear();
                BookList.Items.Add("The Hunger Games");
                BookList.Items.Add("Catching Fire");
                BookList.Items.Add("Mockingjay");
            }
        }
    }
}
